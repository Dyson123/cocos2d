...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	for (int i = 0; i < totalFrames2; i++) {
		sprintf(frameName2, "pulled-diamond-%d.png", i);
	...
	for (int i = 0; i < totalFrames3; i++) {
		sprintf(frameName3, "pulled-gem-mouse-%d.png", i);
		mouseAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName3));
	}
